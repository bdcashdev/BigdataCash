...
The BDCASH Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the BDCASH Core build
system and tests. Refer to the documentation in the repository on how to build
BDCASH Core and how to run the unit and functional tests.
