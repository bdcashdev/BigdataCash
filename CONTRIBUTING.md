Contributing to BDCASH
============================

The BDCASH project operates an open contributor model where anyone is
...
The following applies to code changes to the BDCASH project, and is not to be
confused with overall BIGDATACASH Network Protocol consensus changes.

Whether a pull request is merged into BDCASH rests with the project merge
...
Patches that change BIGDATACASH consensus rules are considerably more involved than
...
Where a patch set proposes to change the BIGDATACASH consensus, it must have been
...
The project leader is the release manager for each BDCASH release.
