...
// Copyright (c) 2018 The BDCASH developers
...
public:
    ...
    void AutoCheck();
    //total aeg paid out by this budget
...
public:
    ...
    */
    ...
    bool IsEstablished()
    {
        ...
        //if (Params().NetworkID() == CBaseChainParams::MAIN) return (nTime < GetTime() - (60 * 60 * 24)); // TODO - uncomment pre-merge
