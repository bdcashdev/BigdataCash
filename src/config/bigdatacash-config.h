/* src/config/bigdatacash-config.h.  Generated from bigdatacash-config.h.in by configure.  */
/* src/config/bigdatacash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BDCASH_CONFIG_H

#define BDCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bigdatacash.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BDCASH Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BDCASH Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bigdatacash"
